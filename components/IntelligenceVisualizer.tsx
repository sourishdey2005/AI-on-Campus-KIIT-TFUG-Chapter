...
const IntelligenceVisualizer: React.FC = () => {
  ...
  return (
    <section id="intelligence-viz" className="py-24 md:py-32 bg-[#050505] relative overflow-hidden border-t border-white/5">
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center mb-16 md:mb-24">
          <h2 className="text-xs uppercase tracking-[0.4em] text-blue-500 font-black mb-6">Execution & Operations</h2>
          <h3 className="text-4xl md:text-6xl font-extrabold tracking-tighter">Production Intelligence</h3>
          <p className="text-neutral-500 mt-6 md:mt-8 max-w-2xl mx-auto text-lg md:xl font-light leading-relaxed">
            Visualizing the industrial lifecycle of AI. From model training and CI/CD automation to edge-cloud synchronization.
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="glass p-8 rounded-[2rem] md:rounded-[2.5rem] border-white/5 flex flex-col justify-between min-h-[300px] md:h-[320px] group overflow-hidden">
            <div>
            ...
            <div className="relative flex justify-between items-center px-4">
              {['☁️', '🌐', '📱', '📡'].map((icon, i) => (
                <div key={i} className="relative z-10 w-8 h-8 md:w-10 md:h-10 rounded-xl glass border-white/10 flex items-center justify-center text-lg bg-black/40">
                  {icon}
                </div>
              ))}
          ...
          <div className="glass p-8 rounded-[2rem] md:rounded-[2.5rem] border-white/5 flex flex-col justify-between min-h-[300px] md:h-[320px] group">
            <div>
          ...
          <div className="glass p-8 rounded-[2rem] md:rounded-[2.5rem] border-white/5 flex flex-col justify-between min-h-[300px] md:h-[320px] group relative overflow-hidden">
            <div>
          ...
          <div className="glass p-8 rounded-[2rem] md:rounded-[2.5rem] border-white/5 flex flex-col justify-between min-h-[300px] md:h-[320px] group">
            ...
            <div className="grid grid-cols-5 gap-1 items-center h-16 md:h-20">
              {['CODE', 'BUILD', 'TRAIN', 'TEST', 'PROD'].map((step, i) => (
                <div key={i} className="flex flex-col items-center gap-2">
                  <div className={`w-6 h-6 md:w-8 md:h-8 rounded-lg flex items-center justify-center transition-all duration-500 ${activeStep === i ? 'bg-purple-600 text-white shadow-[0_0_15px_rgba(147,51,234,0.5)] scale-110' : 'bg-white/5 text-neutral-600'}`}>
                    <div className="w-1 h-1 rounded-full bg-current"></div>
                  </div>
                  <span className="text-[6px] md:text-[7px] font-black uppercase tracking-tighter text-neutral-500">{step}</span>
                </div>
              ))}
            </div>
            <div className="flex items-center gap-2 mt-4 pt-4 border-t border-white/5">
              <span className="w-1.5 h-1.5 rounded-full bg-green-500 animate-pulse"></span>
              <span className="text-[9px] font-black text-neutral-600 uppercase">Status: Nominal</span>
            </div>
          </div>
          ...
          <div className="glass p-8 rounded-[2rem] md:rounded-[2.5rem] border-white/5 flex flex-col justify-between min-h-[300px] md:h-[320px] group relative overflow-hidden">
            ...
            <div className="flex-1 flex items-center justify-center">
              <div className="w-20 h-20 md:w-24 md:h-24 rounded-full border border-dashed border-white/10 relative flex items-center justify-center">
                <motion.div 
                  animate={{ rotate: 360 }}
                ...
                <div className="text-center">
                  ...
                  <span className="text-[9px] md:text-[10px] font-bold text-white">RE-OPTIM</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className={`glass p-8 rounded-[2rem] md:rounded-[2.5rem] transition-all duration-500 flex flex-col justify-between min-h-[300px] md:h-[320px] group ${alertGlow ? 'border-red-500/50 bg-red-500/5' : 'border-white/5'}`}>
            <div>
            ...
            <div className="h-20 md:h-24 flex items-end gap-1">
          ...
          <div className="glass p-8 rounded-[2rem] md:rounded-[2.5rem] border-white/5 flex flex-col justify-between min-h-[300px] md:h-[320px] group">
            ...
            <div className="flex justify-around items-center h-16 md:h-20">
              <div className="w-10 h-10 md:w-12 md:h-12 rounded-2xl glass border-white/10 flex flex-col items-center justify-center">
                <span className="text-[7px] md:text-[8px] text-neutral-500 mb-1">CLOUD</span>
                <span className="text-xs">☁️</span>
              </div>
              <motion.div animate={{ x: [0, 10, 0] }} transition={{ repeat: Infinity, duration: 2 }} className="text-cyan-500">⇄</motion.div>
              <div className="w-10 h-10 md:w-12 md:h-12 rounded-2xl glass border-white/10 flex flex-col items-center justify-center">
                 <span className="text-[7px] md:text-[8px] text-neutral-500 mb-1">EDGE</span>
            ...
            <div className="space-y-2 mt-4">
               ...
               <p className="text-[8px] text-center font-black text-cyan-500 uppercase tracking-widest">Synchronizing...</p>
            </div>
          </div>
          ...
          <div className="glass p-8 rounded-[2rem] md:rounded-[2.5rem] border-white/5 flex flex-col justify-between min-h-[300px] md:h-[320px] group overflow-hidden">
            ...
            <div className="grid grid-cols-2 gap-2 mt-4">
               ...
               <div className="p-3 glass border-white/5 rounded-xl text-center">
                  <p className="text-[8px] font-black text-neutral-500 uppercase tracking-widest mb-1">Latency</p>
                  <p className="text-xs font-bold text-white tracking-tighter">12ms</p>
               </div>
            </div>
          </div>
