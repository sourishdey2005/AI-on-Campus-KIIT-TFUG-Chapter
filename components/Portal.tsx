            ...
            <div className="grid lg:grid-cols-3 gap-8">
               ...
               <div className="lg:col-span-2 glass p-10 rounded-[3rem] border-white/5">
                  ...
                  <div className="prose prose-invert max-w-none text-neutral-400 space-y-4 text-sm leading-relaxed">
                    <p>Welcome to the official AI on Campus – KIIT TFUG internal knowledge base. This wiki is maintained by the Technical Lead wing to ensure seamless knowledge transfer between student cohorts.</p>
