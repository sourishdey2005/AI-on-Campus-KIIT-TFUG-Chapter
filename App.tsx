      ...
      <main>
          ...
          <div className="max-w-7xl mx-auto px-6 relative z-10">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {ACTIVITIES.map((activity, idx) => (
                <div key={idx} className="p-10 rounded-[2rem] glass border-white/5 hover:border-orange-500/40 hover:bg-white/[0.04] transition-all duration-500 group">
            ...
            <div className="grid lg:grid-cols-2 gap-24 items-center">
              <div>
                ...
                <p className="text-neutral-400 text-xl font-light leading-relaxed mb-12">
                  TF LAB is a sanctuary for the exceptional. We identify high-potential students through multi-stage technical audits, live sprints, and peer-consensus interviews.
                </p>
              ...
              <div className="glass p-14 rounded-[3rem] border-white/10 shadow-2xl backdrop-blur-3xl">
                ...
                <div className="grid gap-6">
                  {[
                    ...
                    <div key={i} className="group flex justify-between items-center p-6 rounded-2xl glass border-white/5 hover:border-blue-500/30 transition-all cursor-default">
        ...
        <section className="py-40 bg-gradient-to-b from-transparent to-[#0a0a0a] relative">
          <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
            ...
            <div className="relative glass p-20 rounded-[4rem] border-white/10 shadow-[0_0_80px_rgba(255,111,0,0.08)] backdrop-blur-3xl overflow-hidden group">
              <div className="absolute -top-10 left-1/2 -translate-x-1/2 w-24 h-24 bg-orange-600/20 backdrop-blur-xl border border-orange-500/40 rounded-full flex items-center justify-center text-5xl shadow-2xl group-hover:scale-110 transition-transform duration-500 text-white">“</div>
              <p className="text-3xl md:text-4xl font-extralight text-neutral-200 italic mb-14 leading-[1.4]">
                "We are bridging the void between academic ambition and industrial AI leadership. 
                TF LAB at KIIT is where theoretical curiosities become production-grade realities."
              </p>
              <div className="space-y-3">
                <p className="text-2xl font-black text-white">Office of Faculty In-Charge</p>
                <p className="text-neutral-500 text-[11px] uppercase tracking-[0.4em] font-black">KIIT School of Computer Engineering</p>
                <div className="flex justify-center gap-6 mt-10">
                   <div className="px-5 py-2 glass rounded-full text-[9px] font-black text-orange-500 border-orange-500/30 uppercase tracking-widest">Global Affiliate</div>
                   <div className="px-5 py-2 glass rounded-full text-[9px] font-black text-blue-500 border-blue-500/30 uppercase tracking-widest">Research Certified</div>
                </div>
              </div>
            </div>
          </div>
